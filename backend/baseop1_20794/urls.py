"""baseop1_20794 URL Configuration
...
admin.site.site_header = "BaseOP1"
admin.site.site_title = "BaseOP1 Admin Portal"
admin.site.index_title = "BaseOP1 Admin"

# swagger
api_info = openapi.Info(
    title="BaseOP1 API",
    default_version="v1",
    description="API documentation for BaseOP1 App",
)
